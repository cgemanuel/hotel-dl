...
<div class="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto"
    ...
    <!-- Modal Panel -->
    <div class="relative inline-block align-bottom bg-white dark:bg-zinc-900 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full mx-4">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label for="edit_estacionamiento_no_espacio" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">
                            No. de Espacio de Estacionamiento
                        </label>
                        <input type="number" id="edit_estacionamiento_no_espacio" wire:model="edit_estacionamiento_no_espacio"
                               class="w-full px-3 py-2 border border-zinc-300 dark:border-zinc-600 rounded-md shadow-sm dark:bg-zinc-800 dark:text-zinc-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
