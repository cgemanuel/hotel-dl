    ...
    <div class="modal-overlay fixed inset-0 overflow-y-auto" style="z-index: 9998;" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="modal-container inline-block w-full max-w-4xl overflow-hidden text-left align-bottom transition-all transform bg-white dark:bg-zinc-800 rounded-lg shadow-2xl sm:my-8 sm:align-middle relative" style="z-index: 9999;">
                ...
                <!-- Header fijo -->
                <div class="sticky top-0 z-10 px-6 py-4 border-b border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-800">
                ...
                <div class="px-6 py-4 max-h-[calc(100vh-200px)] overflow-y-auto bg-white dark:bg-zinc-800">
                    ...
                    <form wire:submit.prevent="guardar">
                        ...
                        <!-- Sección: Cliente -->
                        <div class="mb-6">
                            <h4 class="text-md font-semibold text-gray-900 dark:text-gray-100 mb-4">Información del Cliente</h4>
                            ...
                            <div class="mb-4">
                                ...
                                <select wire:model.live="cliente_id" wire:change="seleccionarCliente"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    <option value="">-- Nuevo Cliente --</option>
                                    @foreach($clientes as $cliente)
                                        <option value="{{ $cliente->idclientes }}">{{ $cliente->nom_completo }} - {{ $cliente->telefono }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <!-- Sección: Reserva -->
                        <div class="mb-6">
                            <h4 class="text-md font-semibold text-gray-900 dark:text-gray-100 mb-4">Detalles de la Reserva</h4>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <!-- Estacionamiento (solo se muestra si necesita_estacionamiento es true) -->
                                ...
                                <div class="md:col-span-2 transition-all duration-300 ease-in-out">
                                    ...
                                    @if(count($espacios_estacionamiento) == 0)
                                        <p class="mt-2 text-sm text-yellow-600 dark:text-yellow-400 flex items-center gap-2">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                                            </svg>
                                            No hay espacios de estacionamiento disponibles en este momento.
                                        </p>
                                    @endif
                                </div>
                                @endif
                ...
                <!-- Footer fijo -->
                <div class="sticky bottom-0 px-6 py-4 bg-gray-50 dark:bg-zinc-900 border-t border-gray-200 dark:border-zinc-700">
                    <div class="flex justify-end gap-3">
                        <button type="button"
                                wire:click="cerrar"
                                class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-zinc-800 border border-gray-300 dark:border-zinc-600 rounded-lg hover:bg-gray-50 dark:hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                            Cancelar
                        </button>
                        <button type="button"
                                wire:click="guardar"
