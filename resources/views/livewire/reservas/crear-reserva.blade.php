                    ...
                    <div class="px-6 py-4 max-h-[calc(100vh-200px)] overflow-y-auto bg-white dark:bg-zinc-900">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" wire:model="nom_completo" @if($cliente_existente) readonly @endif placeholder="Ingrese el nombre completo"
                                ...
                                <div>
                                    ...
                                    <select wire:model="tipo_identificacion" @if($cliente_existente) disabled @endif
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model="direccion" @if($cliente_existente) readonly @endif
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-800 text-gray-900 dark:text-gray-100">
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model="pais_origen" @if($cliente_existente) readonly @endif
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-800 text-gray-900 dark:text-gray-100">
                                ...
                                <div>
                                    ...
                                    <input type="email" wire:model="correo" @if($cliente_existente) readonly @endif
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-800 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select wire:model="habitacion_id"
                                        ...
                                        @foreach($habitaciones as $habitacion)
                                            <option value="{{ $habitacion->idhabitacion }}">Hab. {{ $habitacion->no_habitacion }} - {{ $habitacion->tipo }}</option>
                                        @endforeach
                                    </select>
                                ...
                                {{-- ── Método de Pago (con los 2 nuevos tipos de tarjeta) ── --}}
                                <div class="md:col-span-2">
